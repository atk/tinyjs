...
t=function(
    ...
    if (!(n = s.nodeName ? [s] :
        ...
        s.replace(cp, function(f,y,j,k,l,m,o,p,z,q,x) {
            ...
            if (e==='*') { if (z=ss.exec(f)) { S=es(z, S); e=f; return } else { S=t.cf[e](S) } }
...
t.prototype=t._={
    ...
    nf: (function(f,d,s) {
            ...
            f={
                'rgb2hex': function(r,z) { return ((z=rr.exec(r))?['#',z[1],z[1],z[2],z[2],z[3],z[3]].join(''):(z=co.exec(r))?'#'+t.i([1,2,3],function(i, v){this[i]=('0'+(z[v]|0).toString(16)).substr(-2);}).join(''):r) },
            ...
            s=d.getElementsByTagName('i')[0].style;
...
t.f=function(o, c, y, r) {
    ...
    y=y||c===u||o instanceof Array;
    r=y?[]:{};
    c=c || function(i, v, l) { l=i; while (--l>=0) { if (this[l]===v) { return u }} return v };
...
*/
t.w=[].indexOf ? function(x, a) { return a.indexOf(x) } : function(x, a, l) { l=a.length; while (l>-1&&a[--l]!==x); return l };
/*
    parametrize
...
t.a=function(o, x, t) {
    ...
    t = (o.type||'Text');
    if (!o.async) { return t===!0?x:x['response'+t] }
    // if async, set result handler function
    x.onreadystatechange=function(e) { if (x.readyState===4) { o.async.call(x,x['response'+t]) } };
